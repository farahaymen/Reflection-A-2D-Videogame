...
public class L1Cs1Manager : MonoBehaviour
{
    ...
    void Awake() 
    {
        ...
        AudioManager.instance.setSfx(knockSfx);
        ...
        Invoke("StartConvo", 3f); //Dialogue 1
    }
    void Update() 
    {
        if (submitButton)
        ...
        {
            AudioManager.instance.setSfx(openingDoorSfx);
